...
const updateSchedule = (state, action) => {  
    ...
    if (state ===undefined) {
        return {
            buttonListText: 'Добавить',
            buttonListStyle: '',
            buttonListAdded: false,
            list: [
                {
    ...
    switch (action.type) {        
        case "ADD_BUTTON":   
            let {buttonListAdded, buttonListText, buttonListStyle} = state.schedule;
                if(buttonListAdded) {
                buttonListText = 'Добавлено';
                buttonListStyle = 'added';
                buttonListAdded = false;
                }
                else {
                buttonListText = 'Добавить';
                buttonListStyle = '';
                buttonListAdded = true;
                }
